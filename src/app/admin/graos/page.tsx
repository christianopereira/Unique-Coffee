...
export default function AdminGraosPage() {
  return (
    <>
      ...
      <PageBgEditor pageKey="graos" pageTitle="Grãos" />
        ...
        {({ data, updateField }) => (
          <div className="space-y-5">
            ...
            <div className="border-t border-linen pt-4 space-y-3">
              ...
              <TextInput label="Link do botão" value={(data.ctaLink as string) || ""} onChange={(v) => updateField("ctaLink", v)} placeholder="/graos" hint="Página interna: /sobre, /menu, /contacto — Link externo: https://exemplo.com" />
